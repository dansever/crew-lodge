import {
  ...
  t as convertBase64ToUint8Array,
  u as postFormDataToApi,
...
var GroqChatLanguageModel = class {
  ...
  getArgs({
    ...
    const baseArgs = {
      ...
      // provider options:
      reasoning_format:
        groqOptions == null ? void 0 : groqOptions.reasoningFormat,
      // messages:
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      toolCalls:
        (_c = choice.message.tool_calls) == null
          ? void 0
          : _c.map(toolCall => {
              var _a2;
              return {
      ...
      usage: {
        promptTokens:
          (_e = (_d = response.usage) == null ? void 0 : _d.prompt_tokens) !=
          null
            ? _e
            : NaN,
        completionTokens:
          (_g =
            (_f = response.usage) == null ? void 0 : _f.completion_tokens) !=
          null
            ? _g
            : NaN,
      },
        ...
        new TransformStream({
          transform(chunk, controller) {
            ...
            if (((_a = value.x_groq) == null ? void 0 : _a.usage) != null) {
              usage = {
                promptTokens:
                  (_b = value.x_groq.usage.prompt_tokens) != null ? _b : void 0,
                completionTokens:
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                controller.enqueue({
                  ...
                  toolName: toolCall.function.name,
                  argsTextDelta:
                    (_l = toolCallDelta.function.arguments) != null ? _l : '',
                });
                if (
                  ((_m = toolCall.function) == null ? void 0 : _m.name) !=
                    null &&
                  ((_n = toolCall.function) == null ? void 0 : _n.arguments) !=
                    null &&
  ...
  getArgs({ audio, mediaType, providerOptions }) {
    ...
    if (groqOptions) {
      const transcriptionModelOptions = {
        ...
        response_format:
          (_c = groqOptions.responseFormat) != null ? _c : void 0,
        temperature: (_d = groqOptions.temperature) != null ? _d : void 0,
        timestamp_granularities:
          (_e = groqOptions.timestampGranularities) != null ? _e : void 0,
      };
