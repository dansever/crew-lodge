import {
  w as withoutTrailingSlash,
  N as NoSuchModelError,
  l as loadApiKey,
  o as createJsonErrorResponseHandler,
  j as postJsonToApi,
  h as combineHeaders,
  k as createJsonResponseHandler,
  q as generateId,
  m as createEventSourceResponseHandler,
  I as InvalidResponseDataError,
  s as isParsableJson,
  U as UnsupportedFunctionalityError,
  n as convertUint8ArrayToBase64,
} from './index.mjs';
import { z } from 'zod';
...
function getOpenAIMetadata(message) {
  var _a, _b;
  return (_b =
    (_a = message == null ? void 0 : message.providerMetadata) == null
      ? void 0
      : _a.openaiCompatible) != null
    ? _b
    : {};
}
...
var OpenAICompatibleChatLanguageModel = class {
  ...
  constructor(modelId, settings, config) {
    ...
    this.supportsStructuredOutputs =
      (_b = config.supportsStructuredOutputs) != null ? _b : false;
  }
      ...
      reasoning_effort:
        (_d =
          (_b =
            providerMetadata == null
              ? void 0
              : providerMetadata[this.providerOptionsName]) == null
            ? void 0
            : _b.reasoningEffort) != null
          ? _d
          : (_c =
                providerMetadata == null
                  ? void 0
                  : providerMetadata['openai-compatible']) == null
            ? void 0
            : _c.reasoningEffort,
      // messages:
  ...
  async doGenerate(options) {
    ...
    const providerMetadata = {
      ...
      ...((_b =
        (_a = this.config.metadataExtractor) == null
          ? void 0
          : _a.extractMetadata) == null
        ? void 0
        : _b.call(_a, {
    ...
    const completionTokenDetails =
      (_c = responseBody.usage) == null ? void 0 : _c.completion_tokens_details;
    const promptTokenDetails =
      (_d = responseBody.usage) == null ? void 0 : _d.prompt_tokens_details;
    if (
    ...
    return {
      ...
      toolCalls:
        (_g = choice.message.tool_calls) == null
          ? void 0
          : _g.map(toolCall => {
              var _a2;
              return {
      ...
      usage: {
        promptTokens:
          (_i =
            (_h = responseBody.usage) == null ? void 0 : _h.prompt_tokens) !=
          null
            ? _i
            : NaN,
        completionTokens:
          (_k =
            (_j = responseBody.usage) == null
              ? void 0
              : _j.completion_tokens) != null
            ? _k
            : NaN,
      },
      providerMetadata,
        ...
        new TransformStream({
          ...
          transform(chunk, controller) {
            ...
            if (value.usage != null) {
              ...
              usage.promptTokens =
                prompt_tokens != null ? prompt_tokens : void 0;
              usage.completionTokens =
                completion_tokens != null ? completion_tokens : void 0;
              if (
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (
                    ((_a2 = toolCallDelta.function) == null
                      ? void 0
                      : _a2.name) == null
                  ) {
                    throw new InvalidResponseDataError({
                  ...
                  toolCalls[index] = {
                    ...
                    function: {
                      ...
                      arguments:
                        (_b = toolCallDelta.function.arguments) != null
                          ? _b
                          : '',
                    },
                    hasFinished: false,
                  ...
                  if (
                    ((_c = toolCall2.function) == null ? void 0 : _c.name) !=
                      null &&
                    ((_d = toolCall2.function) == null
                      ? void 0
                      : _d.arguments) != null
                  ) {
                    ...
                    if (isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        ...
                        toolCallType: 'function',
                        toolCallId:
                          (_e = toolCall2.id) != null ? _e : generateId(),
                        toolName: toolCall2.function.name,
                ...
                if (
                  ((_f = toolCallDelta.function) == null
                    ? void 0
                    : _f.arguments) != null
                ) {
                  toolCall.function.arguments +=
                    (_h =
                      (_g = toolCallDelta.function) == null
                        ? void 0
                        : _g.arguments) != null
                      ? _h
                      : '';
                ...
                controller.enqueue({
                  ...
                  toolName: toolCall.function.name,
                  argsTextDelta:
                    (_i = toolCallDelta.function.arguments) != null ? _i : '',
                });
                if (
                  ((_j = toolCall.function) == null ? void 0 : _j.name) !=
                    null &&
                  ((_k = toolCall.function) == null ? void 0 : _k.arguments) !=
                    null &&
...
var openaiCompatibleTokenUsageSchema = z
  .object({
...
var OpenAICompatibleImageModel = class {
  ...
  async doGenerate({
    ...
    const currentDate =
      (_c =
        (_b = (_a = this.config._internal) == null ? void 0 : _a.currentDate) ==
        null
          ? void 0
          : _b.call(_a)) != null
        ? _c
    ...
    const { value: response, responseHeaders } = await postJsonToApi({
      ...
      failedResponseHandler: createJsonErrorResponseHandler(
        (_e = this.config.errorStructure) != null
          ? _e
          : defaultOpenAICompatibleErrorStructure
      ),
      successfulResponseHandler: createJsonResponseHandler(
