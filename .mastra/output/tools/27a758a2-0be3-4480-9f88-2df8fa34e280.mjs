...
const isMastraContext = typeof process !== "undefined" && (process.env.MASTRA_DEV === "true" || process.env.SKIP_ENV_VALIDATION === "true" || process.cwd().includes(".mastra") || process.argv.some((arg) => arg.includes("mastra")));
