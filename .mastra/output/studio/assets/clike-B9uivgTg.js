...
function h(e) {
  ...
  return {
    ...
    indent: function (i, a, c) {
      if (
        (i.tokenize != K && i.tokenize != null) ||
        (i.typeAtEndOfLine && P(i.context))
      )
        return null;
      var o = i.context,
        u = a && a.charAt(0),
...
const _e = h({
  ...
  Ie = h({
    ...
    defKeywords: r(
      z + ' @interface @implementation @protocol @class class namespace'
    ),
    dontIndentStatements: /^@.*$|^template$/,
    typeFirstDefinitions: !0,
    atoms: r('YES NO NULL Nil nil true false nullptr'),
...
const De = h({
  ...
  hooks: {
    ...
    '"': function (e, n) {
      return (
        (n.tokenize = ee(e.match('""') ? 'triple' : 'single')),
        n.tokenize(e, n)
      );
    },
    '`': function (e, n) {
      return !L || !e.match('`')
        ? !1
        : ((n.tokenize = L), (L = null), n.tokenize(e, n));
    },
    "'": function (e) {
      return e.match(/^(\\[^'\s]+|[^\\'])'/)
        ? 'string.special'
...
function ye(e, n) {
  return (
    e.eat('$'),
    e.eat('{') ? (n.tokenize = null) : (n.tokenize = me),
    null
  );
}
function me(e, n) {
