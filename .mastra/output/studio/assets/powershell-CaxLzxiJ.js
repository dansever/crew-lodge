function a(e, n) {
  n = n || {};
  for (
    var r = n.prefix !== void 0 ? n.prefix : '^',
      o = n.suffix !== void 0 ? n.suffix : '\\b',
      i = 0;
    i < e.length;
    i++
  )
...
function t(e, n) {
  ...
  if (e.eat(')')) return ((n.bracketNesting -= 1), 'punctuation');
  for (var o in p) if (e.match(p[o])) return o;
  var i = e.next();
  if (i === "'") return R(e, n);
  if (i === '$') return s(e, n);
  if (i === '"') return v(e, n);
...
function v(e, n) {
  for (var r; (r = e.peek()) != null; ) {
    ...
    if (r === '"' && !e.eat('"')) return ((n.tokenize = t), 'string');
  }
  return 'error';
}
function I(e, n) {
...
function s(e, n) {
  ...
  return e.eat('{')
    ? ((n.tokenize = m), m(e, n))
    : r != null && r.match(c)
      ? (e.eatWhile(c), (n.tokenize = t), 'variable')
      : ((n.tokenize = t), 'error');
}
function m(e, n) {
...
function u(e, n) {
  ...
  if (e.sol() && e.match(new RegExp(r + '@'))) n.tokenize = t;
    ...
    for (; !e.eol(); ) {
      var o = e.peek();
      if (o === '$') return ((n.tokenize = T), 'string');
      (e.next(), o === '`' && e.next());
    }
  else e.skipToEnd();
  return 'string';
...
const D = {
  name: 'powershell',
  startState: function () {
    return { returnStack: [], bracketNesting: 0, tokenize: t };
  },
  token: function (e, n) {
