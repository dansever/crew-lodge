...
function p(e, i) {
  ...
  if (n == '%') {
    ...
    var u = e.eat(/[^\w\s=]/);
    return u
      ? (h.propertyIsEnumerable(u) && (u = h[u]), c(d(u, l, r, !0), e, i))
      : 'operator';
  } else {
...
function y() {
  ...
  return function (i, n) {
    return e
      ? (n.tokenize.pop(), n.tokenize[n.tokenize.length - 1](i, n))
      : ((e = !0), p(i, n));
  };
}
function d(e, i, n, o) {
  return function (l, r) {
    var u = !1,
      t;
    for (
      r.context.type === 'read-quoted-paused' &&
      ((r.context = r.context.prev), l.eat('}'));
      (t = l.next()) != null;
    ) {
      if (t == e && (o || !u)) {
        r.tokenize.pop();
      ...
      if (n && t == '#' && !u) {
        if (l.eat('{')) {
          (e == '}' &&
            (r.context = { prev: r.context, type: 'read-quoted-paused' }),
            r.tokenize.push(a()));
          break;
        } else if (/[@\$]/.test(l.peek())) {
          r.tokenize.push(y());
...
function s(e, i) {
  return function (n, o) {
    return (
      i && n.eatSpace(),
      n.match(e) ? o.tokenize.pop() : n.skipToEnd(),
      'string'
    );
  };
}
function w(e, i) {
  return (
    e.sol() && e.match('=end') && e.eol() && i.tokenize.pop(),
    e.skipToEnd(),
    'comment'
  );
}
  ...
  indent: function (e, i, n) {
    ...
    var o = i && i.charAt(0),
      ...
      r =
        l.type == _[o] ||
        (l.type == 'keyword' &&
          /^(?:end|until|else|elsif|when|rescue)\b/.test(i));
