  ...
  iO = new i((O, $) => {
    ...
    if (O.peek(-1) == r) {
      ...
      a != Q &&
        O.next != r &&
        !h(O) &&
        (a < Q ? O.acceptToken(X, -a) : O.acceptToken(j));
    }
  }),
  oO = new i((O, $) => {
...
const cO = new b(null, 0),
  ...
  YO = g(O => O.name == 'VariableName' || O.name == 'SassVariableName');
function ZO(O) {
  return new V(O?.indented ? wO : P, P.data.of({ autocomplete: YO }));
}
export { ZO as sass, YO as sassCompletionSource, P as sassLanguage };
