...
function h(i, n) {
  if (
    (i.sol() && ((n.javaScriptLine = !1), (n.javaScriptLineExcludesColon = !1)),
    n.javaScriptLine)
  ) {
...
function j(i, n) {
  if (i.match(/^when\b/))
    return (
      (n.javaScriptLine = !0),
      (n.javaScriptLineExcludesColon = !0),
      'keyword'
    );
}
function k(i) {
...
function a(i, n) {
  if (n.isAttrs) {
    ...
    var t = e.token(i, n.jsState);
    if (
      n.attrsNest.length === 0 &&
      (t === 'string' || t === 'variable' || t === 'keyword')
    )
      try {
        return (
          Function(
            '',
            'var x ' + n.attrValue.replace(/,\s*$/, '').replace(/^!/, '')
          ),
          (n.inAttributeName = !0),
          (n.attrValue = ''),
...
function Z(i, n) {
  if (i.match(/^ *\/\/(-)?([^\n]*)/))
    return (
      (n.indentOf = i.indentation()),
      (n.indentToken = 'comment'),
      'comment'
    );
}
function $(i) {
