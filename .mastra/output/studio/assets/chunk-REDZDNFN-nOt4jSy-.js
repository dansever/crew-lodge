import { J as V, K as O, M as A } from './main-DPFIre7N.js';
var J = { env: {} },
  w = {},
  F = V({
    '../../../node_modules/.pnpm/@vercel+oidc@3.0.5/node_modules/@vercel/oidc/dist/token-io.js'(
      ...
      var g = Object.create,
        ...
        m = (o, n) => {
          for (var d in n) u(o, d, { get: n[d], enumerable: !0 });
        },
        v = (o, n, d, h) => {
          if ((n && typeof n == 'object') || typeof n == 'function')
            for (let f of D(n))
              !b.call(o, f) &&
                ...
                u(o, f, {
                  get: () => n[f],
                  enumerable: !(h = P(n, f)) || h.enumerable,
                });
          return o;
        },
        _ = (o, n, d) => (
          ...
          v(
            !o || !o.__esModule
              ? u(d, 'default', { value: o, enumerable: !0 })
              : d,
            o
          )
        ),
        E = o => v(u({}, '__esModule', { value: !0 }), o),
        k = {};
      (m(k, { findRootDir: () => y, getUserDataDir: () => S }),
        (j.exports = E(k)));
      var c = _(O('path')),
        s = _(O('fs')),
        a = _(O('os')),
      ...
      function y() {
        try {
          ...
          for (; o !== c.default.dirname(o); ) {
            ...
            if (s.default.existsSync(n)) return o;
        ...
        throw new p.VercelOidcTokenError('Unable to find root directory');
      }
      function S() {
        if (w.XDG_DATA_HOME) return w.XDG_DATA_HOME;
        switch (a.default.platform()) {
          case 'darwin':
            return c.default.join(
              a.default.homedir(),
          ...
          case 'win32':
            return w.LOCALAPPDATA ? w.LOCALAPPDATA : null;
          default:
            return null;
        }
      }
  ...
  $ = V({
    '../../../node_modules/.pnpm/@vercel+oidc@3.0.5/node_modules/@vercel/oidc/dist/token-util.js'(
          ...
          if ((r && typeof r == 'object') || typeof r == 'function')
            for (let l of D(r))
              !b.call(e, l) &&
                ...
                u(e, l, {
                  get: () => r[l],
                  enumerable: !(i = P(r, l)) || i.enumerable,
                });
          return e;
        },
        _ = (e, r, t) => (
          ...
          v(
            !e || !e.__esModule
              ? u(t, 'default', { value: e, enumerable: !0 })
              : t,
            e
          )
        ),
        E = e => v(u({}, '__esModule', { value: !0 }), e),
        k = {};
      (m(k, {
      ...
      var c = _(O('path')),
        ...
        p = F();
      function y() {
        const e = 'com.vercel.cli',
          r = (0, p.getUserDataDir)();
      ...
      function S() {
        ...
        if (!s.existsSync(r)) return null;
        const t = s.readFileSync(r, 'utf8');
        return t ? JSON.parse(t).token : null;
      }
      async function o(e, r, t) {
        try {
          const i = `https://api.vercel.com/v1/projects/${r}/token?source=vercel-oidc-refresh${t ? `&teamId=${t}` : ''}`,
            l = await fetch(i, {
              method: 'POST',
      ...
      function h(e, r) {
        try {
          const t = (0, p.getUserDataDir)();
          if (!t)
            throw new a.VercelOidcTokenError(
              'Unable to find user data directory'
            );
          const i = c.join(t, 'com.vercel.token', `${r}.json`),
            l = JSON.stringify(e);
          (s.mkdirSync(c.dirname(i), { mode: 504, recursive: !0 }),
            s.writeFileSync(i, l),
            s.chmodSync(i, 432));
          return;
        } catch (t) {
      ...
      function f(e) {
        try {
          const r = (0, p.getUserDataDir)();
          if (!r) return null;
          const t = c.join(r, 'com.vercel.token', `${e}.json`);
          if (!s.existsSync(t)) return null;
      ...
      function M(e) {
        const r = e.split('.');
        if (r.length !== 3) throw new a.VercelOidcTokenError('Invalid token');
        const t = r[1].replace(/-/g, '+').replace(/_/g, '/'),
