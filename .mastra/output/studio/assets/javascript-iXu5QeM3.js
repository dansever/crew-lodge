function fr(x) {
    ...
    if (t == '/')
      return r.eat('*')
        ...
        : r.eat('/')
          ...
          : ce(r, e, 1)
            ? (qr(r),
              r.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/),
              b('regexp', 'string.special'))
  ...
  function q(r) {
    ...
    x.globalVars &&
      !or(r, e.globalVars) &&
      (e.globalVars = new Q(r, e.globalVars));
  }
  function gr(r, e) {
    if (e)
      if (e.block) {
  ...
  function E() {
    ((i.state.context = new P(i.state.context, i.state.localVars, !1)),
      (i.state.localVars = Dr));
  }
  function Y() {
    ((i.state.context = new P(i.state.context, i.state.localVars, !0)),
  ...
  return {
    ...
    startState: function (r) {
      ...
      return (
        x.globalVars &&
          typeof x.globalVars == 'object' &&
          (e.globalVars = x.globalVars),
        e
      );
    },
    token: function (r, e) {
          ...
          : v == 'form'
            ...
            : v == 'stat'
              ...
              : u.info == 'switch' && !K && x.doubleIndentSwitch != !1
                ? u.indented +
                  (/^(?:case|default)\b/.test(e) ? t.unit : 2 * t.unit)
                : u.align
                  ? u.column + (K ? 0 : 1)
