  ...
  createRe: function (i) {
    switch (i) {
      ...
      case 'tableCellAttributes':
        return t.makeRe(
          '^',
          t.choiceRe(t.single.tableCellAttributes, l('allAttributes')),
          '+\\.'
        );
      case 'type':
...
var r = {
  ...
  attributes: function (i, e) {
    return (
      (e.mode = r.layoutLength),
      i.match(l('attributes')) ? f.attributes : u(e)
    );
  },
  layoutLength: function (i, e) {
    return (
      i.eat('.') && i.eat('.') && (e.spanningLayout = !0),
      (e.mode = r.text),
      u(e)
    );
  },
  ...
  link: function (i, e) {
    return (
      (e.mode = r.text),
      i.match(l('link')) ? (i.match(/\S+/), f.link) : u(e)
    );
  },
  ...
  tableCellAttributes: function (i, e) {
    return (
      (e.mode = r.tableText),
      i.match(l('tableCellAttributes')) ? f.attributes : u(e)
    );
  },
