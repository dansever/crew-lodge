  ...
  return {
    ...
    copyState: function (o) {
      var g = {
        state: o.state,
        pending: o.pending,
        indent: o.indent && o.indent.slice(0),
      };
  ...
  return function (i, e) {
    ...
    for (var d = n[e.state], u = 0; u < d.length; u++) {
      ...
      if (t) {
        ...
        if (
          (f && f.apply && (f = f(t)),
          t.length > 2 && r.token && typeof r.token != 'string')
        ) {
          e.pending = [];
...
function x(n, i) {
  return function (e, p) {
    if (
      e.indent == null ||
      (i.dontIndentStates && i.dontIndentStates.indexOf(e.state) > -1)
    )
      return null;
    ...
    n: for (;;) {
      for (var r = 0; r < u.length; r++) {
        ...
        if (t.data.dedent && t.data.dedentIfLineStart !== !1) {
          ...
          if (f && f[0]) {
            (d--,
              (t.next || t.push) && (u = n[t.next || t.push]),
