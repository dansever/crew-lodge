function A(i) {
  ...
  function _(e, n) {
    ...
    if (
      (a[t] && (r = a[t](e, n)) != !1) ||
      (a.tokenBase && (r = a.tokenBase(e, n)) != !1)
    )
      return r;
    ...
    token: function (e, n) {
      ...
      if ((t.align == null && (t.align = !0), d == t.type)) C(n);
        ...
        !(
          v == 'function' &&
          t &&
          (t.type == 'statement' || t.type == 'endgroup')
        )
      ) {
        ...
        if (a <= o.tlvIndentationStyle.length) {
          ...
          if (h < i.string.length) {
            ...
            E[k] &&
              ...
              z[c[1]] &&
              ((s += S),
              (k == '\\' && h > 0) || ((o.tlvIndentationStyle[a] = E[k]), a++));
          }
          if (!g)
      ...
      if (o.tlvCodeActive) {
        ...
        if (u === void 0)
          if (o.tlvInBlockComment)
            (i.match(/^.*?\*\//) ? (o.tlvInBlockComment = !1) : i.skipToEnd(),
              (u = 'comment'));
          else if ((c = i.match(G)) && !o.tlvInBlockComment)
            (c[0] == '//' ? i.skipToEnd() : (o.tlvInBlockComment = !0),
              (u = 'comment'));
          else if ((c = i.match(q))) {
            var b = c[1],
              I = c[2];
