    ...
    (O, e) => {
      ...
      if (O.next == 45)
        (O.advance(),
          l(O.next) &&
            O.acceptToken(
              e.context.type == T && e.context.depth == X(O, O.pos - 1) ? H : y
            ));
      else if (O.next == 63)
        (O.advance(),
          l(O.next) &&
            O.acceptToken(
              e.context.type == g && e.context.depth == X(O, O.pos - 1) ? F : Z
            ));
      else {
        let a = O.pos;
        for (;;)
        ...
        if (O.next == 58) {
          ...
          l(r) &&
            O.acceptTokenTo(
              e.context.type == g && e.context.depth == X(O, a) ? K : z,
              a
            );
        }
      }
...
function w(O, e, a, r) {
  if (
    S(O.next) == 's' ||
    ((O.next == 63 || O.next == 58 || O.next == 45) && k(O.peek(1), a))
  )
    O.advance();
  else return !1;
  let o = O.pos;
