...
function u(e, n) {
  if (e.sol()) {
    ...
    if (e.eatSpace()) {
      var f = e.indentation();
      return f > i && n.scope.type == 'coffee'
        ? 'indent'
        : f < i
          ? 'dedent'
          : null;
  ...
  if (e.match(A)) {
    if (e.current() != '/' || e.match(/^.*\//, !1))
      return (
        (n.tokenize = t(e.current(), !0, 'string.special')),
        n.tokenize(e, n)
      );
    e.backUp(1);
  }
...
function E(e, n) {
  ...
  return (
    n.dedent &&
      e.eol() &&
      (n.scope.type == 'coffee' && n.scope.prev && (n.scope = n.scope.prev),
      (n.dedent = !1)),
  ...
  token: function (e, n) {
    ...
    return (
      f &&
        f != 'comment' &&
        (i && (i.align = !0),
        (n.prop = f == 'punctuation' && e.current() == '.')),
      f
    );
  },
  indent: function (e, n) {
