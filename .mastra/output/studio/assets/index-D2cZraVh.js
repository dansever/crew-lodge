...
const W = new S((T, Q) => {
  ...
  o = i.define({
    name: 'less',
    parser: g.configure({
      props: [y.add({ Declaration: X() }), P.add({ Block: m })],
    }),
    languageData: {
  ...
  u = r(T => T.name == 'VariableName' || T.name == 'AtKeyword');
function Y() {
  return new n(o, o.data.of({ autocomplete: u }));
}
export { Y as less, u as lessCompletionSource, o as lessLanguage };
