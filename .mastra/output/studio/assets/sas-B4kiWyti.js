...
s('def', 'filevar finfo finv fipname fipnamel fipstate first firstobs floor', [
  'inDataStep',
]);
s(
  'def',
...
s('builtin', 'proc run; quit; libname filename %macro %mend option options', [
  'ALL',
]);
...
function d(e, r) {
  ...
  if (((n = n.toLowerCase()), r.inDataStep)) {
    ...
    if (
      n &&
      t.hasOwnProperty(n) &&
      (t[n].state.indexOf('inDataStep') !== -1 ||
