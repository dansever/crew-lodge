...
function Z(t, e) {
  ...
  if (t.next == 69 || t.next == 101)
    for (
      t.advance(), (t.next == 43 || t.next == 45) && t.advance();
      t.next >= 48 && t.next <= 57;
    )
      t.advance();
}
...
function M(t, e, a) {
  ...
  for (let i of t.split(' ')) i && (r[i] = E);
  for (let i of e.split(' ')) i && (r[i] = W);
  for (let i of (a || '').split(' ')) i && (r[i] = Te);
  return r;
}
const h =
...
function Be(t, e, a, r) {
  let i = {};
  for (let s in T) i[s] = (t.hasOwnProperty(s) ? t : T)[s];
  return (e && (i.words = M(e, a || '', r)), i);
}
function K(t) {
  return new ce(e => {
    var a;
    ...
    if ((e.advance(), _(r, S))) {
      ...
      let i = P(e, '');
      e.next == 36 && (e.advance(), ze(e, i), e.acceptToken(b));
    } else if (r == 39 || (r == 34 && t.doubleQuotedStrings))
      (g(e, r, t.backslashEscapes), e.acceptToken(b));
    else if (
      (r == 35 && t.hashComments) ||
      (r == 47 && e.next == 47 && t.slashComments)
    )
      (N(e), e.acceptToken(X));
    else if (
      r == 45 &&
      e.next == 45 &&
      (!t.spaceAfterDashes || e.peek(1) == 32)
    )
      (N(e), e.acceptToken(X));
      ...
      let i = e.peek(1);
      (e.advance(2), Ue(e, i), e.acceptToken(b));
    } else if (_(r, t.identifierQuotes)) {
      const i = r == 91 ? 93 : r;
      (g(e, i, !1), e.acceptToken(qe));
      ...
      (e.advance(),
        t.treatBitsAsBytes
          ? (g(e, i, t.backslashEscapes), e.acceptToken(Pe))
          : (D(e, i), e.acceptToken(R)));
    } else if (
      ...
      (i && e.next == 39 && e.advance(), e.acceptToken(C));
      ...
      let i = P(e, String.fromCharCode(r));
      e.acceptToken(
        e.next == 46 || e.peek(-i.length - 1) == 46
          ? I
          : (a = t.words[i.toLowerCase()]) !== null && a !== void 0
            ? a
            : I
      );
    }
...
function Re(t, e) {
  ...
  return a.name == 'Identifier' ||
    ...
    ? {
        ...
        quoted:
          a.name == 'QuotedIdentifier'
            ? t.doc.sliceString(a.from, a.from + 1)
            : null,
        parents: V(t.doc, j(a)),
        aliases: r,
      }
...
function Ze(t, e) {
  let a;
  for (let i = e; !a; i = i.parent) {
    if (!i) return null;
    i.name == 'Statement' && (a = i);
  }
  let r = null;
  for (let i = a.firstChild, s = !1, c = null; i; i = i.nextSibling) {
    let l =
        i.name == 'Keyword' ? t.sliceString(i.from, i.to).toLowerCase() : null,
      o = null;
    if (!s) s = l == 'from';
    else if (l == 'as' && c && Q(i.nextSibling)) o = x(t, i.nextSibling);
    else {
      if (l && De.has(l)) break;
      c && Q(i) && (o = x(t, i));
    }
    (o && (r || (r = Object.create(null)), (r[o] = Ie(t, c))),
      (c = /Identifier$/.test(i.name) ? i : null));
  }
  return r;
}
function Ne(t, e, a) {
...
class z {
  ...
  addCompletions(e) {
    for (let a of e)
      this.addCompletion(
        typeof a == 'string'
          ? A(a, 'property', this.idQuote, this.idCaseInsensitive)
          : a
      );
  }
  addNamespace(e) {
  ...
  addNamespaceObject(e) {
    for (let a of Object.keys(e)) {
      let r = e[a],
        ...
        c = this;
      $(r) && ((i = r.self), (r = r.children));
      for (let l = 0; l < s.length; l++)
        (i && l == s.length - 1 && c.addCompletion(i),
          (c = c.child(s[l].replace(/\\\./g, '.'))));
      c.addNamespace(r);
    }
  }
}
...
function Ae(t, e, a, r, i, s) {
  var c;
  let l =
      ((c = s?.spec.identifierQuotes) === null || c === void 0
        ? void 0
        : c[0]) || '"',
    o = new z(l, !!s?.spec.caseInsensitiveIdentifiers),
    u = i ? o.child(i) : null;
  return (
    o.addNamespace(t),
    ...
    p => {
      ...
      if (
        (d == o &&
          O &&
          (w = w.concat(
            Object.keys(O).map(f => ({ label: f, type: 'constant' }))
          )),
        B)
      ) {
        let f = B[0],
...
function We(t, e, a) {
  let r = Object.keys(t).map(i => a(e ? i.toUpperCase() : i, Ee(t[i])));
  return de(
...
function Ye(t) {
  return t.schema
    ? (t.dialect || U).language.data.of({ autocomplete: Ge(t) })
    : [];
}
function tt(t = {}) {
  let e = t.dialect || U;
  return new ie(e.language, [
    Ye(t),
    e.language.data.of({
