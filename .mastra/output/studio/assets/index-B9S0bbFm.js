...
function n(O, e, a) {
  return new p(t => {
    ...
    for (
      ...
      t.next != O &&
      t.next >= 0 &&
      (a || (t.next != 38 && (t.next != 123 || t.peek(1) != 123)));
    )
      t.advance();
...
const d = n(39, $, !1),
  ...
  w = { parser: i.parser },
  U = Q.configure({
    wrap: l((O, e) => (O.name == 'InterpolationContent' ? o : null)),
  }),
  y = Q.configure({
    wrap: l((O, e) => {
      var a;
...
function h(O = {}) {
  ...
  return new P(e.language == s.language ? k : S(e.language), [
    e.support,
    e.language.data.of({
...
export { h as angular, k as angularLanguage };
