      ...
      if (e.next == 60) {
        if ((e.advance(), e.next == 47)) {
          ...
          for (let O = t.context; O; O = O.parent)
            if (O.name == o) return e.acceptToken(L, -2);
          e.acceptToken(K);
...
function ge(e, t) {
  ...
  for (
    ...
    O.parent &&
    O.to == t &&
    !(!((o = O.lastChild) === null || o === void 0) && o.type.isError);
  )
    O = O.parent;
  ...
  constructor(t, o, O) {
    ((this.attrs = o),
      ...
      (this.completion = Object.assign(
        Object.assign({ type: 'type' }, t.completion || {}),
        { label: this.name }
      )),
      ...
      (this.text = t.textContent
        ? t.textContent.map(r => ({ label: r, type: 'text' }))
        : []));
  }
}
const b = /^[:\-\.\w\u00b7-\uffff]*$/;
...
function pe(e, t) {
  ...
  for (let n of t) {
    ...
    (o.push($),
      n.global && O.push($),
      n.values && (r[n.name] = n.values.map(R)));
  }
  let a = [],
    s = [],
      ...
      ($ = $.concat(
        n.attributes.map(l =>
          typeof l == 'string'
            ...
            : (l.values &&
                (c == r && (c = Object.create(c)),
                (c[l.name] = l.values.map(R))),
              E(l))
        )
      ));
    let u = new ue(n, $, c);
  ...
  return n => {
    ...
    if (l == 'openTag') {
      ...
      return i
        ? {
            ...
            options: [
              (($ = f[i]) === null || $ === void 0
                ? void 0
                : $.closeNameCompletion) || { label: i + '>', type: 'type' },
            ],
            validFor: b,
          }
        : null;
      ...
      let i = f[T(c, S)];
      return { from: d, options: i?.attrs || O, validFor: b };
    } else if (l == 'attrValue') {
      let i = Se(c, S, d);
      if (!i) return null;
      let m = f[T(c, S)],
      ...
      i &&
        ...
        g.push(
          m
            ? m.closeCompletion
            : { label: '</' + i + '>', type: 'type', boost: 2 }
        );
      let v = g.concat((m?.children || (S ? a : s)).map(x => x.openCompletion));
      if (S && m?.text.length) {
        let x = S.firstChild;
        x.to > n.pos - 20 &&
          !/\S/.test(n.state.sliceDoc(x.to, n.pos)) &&
          (v = v.concat(m.text));
      }
...
function xe(e = {}) {
  let t = [
    w.data.of({ autocomplete: pe(e.elements || [], e.attributes || []) }),
  ];
...
const fe = Y.inputHandler.of((e, t, o, O, r) => {
  ...
  let a = r(),
    ...
    f = s.changeByRange(n => {
      ...
      if (d && O == '>' && S.name == 'EndTag') {
        ...
        if (
          ((c =
            ($ = m.parent) === null || $ === void 0 ? void 0 : $.lastChild) ===
            null || c === void 0
            ? void 0
            : c.name) != 'CloseTag' &&
        ...
        if (
          S.from == l - 2 &&
          ((u = m.lastChild) === null || u === void 0 ? void 0 : u.name) !=
            'CloseTag' &&
          (i = z(s.doc, m, l))
        ) {
          let g = l + (s.doc.sliceString(l, l + 1) === '>' ? 1 : 0),
  ...
  return f.changes.empty
    ...
    : (e.dispatch([
        a,
        s.update(f, { userEvent: 'input.complete', scrollIntoView: !0 }),
      ]),
      !0);
});
export {
