...
function convertToAnthropicMessagesPrompt({ prompt, sendReasoning, warnings }) {
  ...
  function getCacheControl(providerMetadata) {
    var _a2;
    const anthropic2 =
      providerMetadata == null ? void 0 : providerMetadata.anthropic;
...
function groupIntoBlocks(prompt) {
  ...
  for (const message of prompt) {
    ...
    switch (role) {
      ...
      case 'assistant': {
        if (
          (currentBlock == null ? void 0 : currentBlock.type) !== 'assistant'
        ) {
...
var AnthropicMessagesLanguageModel = class {
  ...
  async getArgs({
    ...
    const isThinking =
      ((_b = anthropicOptions == null ? void 0 : anthropicOptions.thinking) ==
      null
        ? void 0
        : _b.type) === 'enabled';
    const thinkingBudget =
      (_c = anthropicOptions == null ? void 0 : anthropicOptions.thinking) ==
      null
        ? void 0
        : _c.budgetTokens;
    const baseArgs = {
  ...
  transformRequestBody(args) {
    var _a, _b, _c;
    return (_c =
      (_b = (_a = this.config).transformRequestBody) == null
        ? void 0
        : _b.call(_a, args)) != null
      ? _c
      : args;
  }
      ...
      providerMetadata: {
        anthropic: {
          cacheCreationInputTokens:
            (_c = response.usage.cache_creation_input_tokens) != null
              ? _c
              : null,
          cacheReadInputTokens:
            (_d = response.usage.cache_read_input_tokens) != null ? _d : null,
        },
      },
            ...
            switch (value.type) {
              ...
              case 'message_start': {
                ...
                providerMetadata = {
                  anthropic: {
                    cacheCreationInputTokens:
                      (_a = value.message.usage.cache_creation_input_tokens) !=
                      null
                        ? _a
                        : null,
                    cacheReadInputTokens:
                      (_b = value.message.usage.cache_read_input_tokens) != null
                        ? _b
                        : null,
                  },
                };
