import {
  ...
  q as generateId,
  l as loadApiKey,
  T as TooManyEmbeddingValuesForCallError,
  h as combineHeaders,
  i as resolve,
  j as postJsonToApi,
  p as parseProviderOptions,
    ...
    if (
      anyOf.some(
        schema =>
          ...
          (schema == null ? void 0 : schema.type) === 'null'
      )
    ) {
              ...
              parts.push(
                part.image instanceof URL
                  ? {
                      fileData: {
                        mimeType:
                          (_a = part.mimeType) != null ? _a : 'image/jpeg',
                  ...
                  : {
                      inlineData: {
                        mimeType:
                          (_b = part.mimeType) != null ? _b : 'image/jpeg',
...
var GoogleGenerativeAILanguageModel = class {
  ...
  async getArgs({
    ...
    if (
      ((_a = googleOptions == null ? void 0 : googleOptions.thinkingConfig) ==
      null
        ? void 0
        : _a.includeThoughts) === true &&
    ...
    const generationConfig = {
      ...
      // provider options:
      responseModalities:
        googleOptions == null ? void 0 : googleOptions.responseModalities,
      thinkingConfig:
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      files:
        (_a = getInlineDataParts(parts)) == null
          ? void 0
          : _a.map(part => ({
      ...
      usage: {
        promptTokens:
          (_b =
            usageMetadata == null ? void 0 : usageMetadata.promptTokenCount) !=
          null
            ? _b
            : NaN,
        completionTokens:
      ...
      providerMetadata: {
        google: {
          groundingMetadata:
            (_d = candidate.groundingMetadata) != null ? _d : null,
        ...
        new TransformStream({
          transform(chunk, controller) {
            ...
            if (usageMetadata != null) {
              usage = {
                promptTokens:
                  (_a = usageMetadata.promptTokenCount) != null ? _a : NaN,
                completionTokens:
                  (_b = usageMetadata.candidatesTokenCount) != null ? _b : NaN,
              };
            }
            ...
            if (candidate.finishReason != null) {
              ...
              providerMetadata = {
                google: {
                  groundingMetadata:
                    (_e = candidate.groundingMetadata) != null ? _e : null,
                  safetyRatings:
                    (_f = candidate.safetyRatings) != null ? _f : null,
                },
              };
            }
          },
...
function getToolCallsFromParts({ parts, generateId: generateId2 }) {
  const functionCallParts =
    parts == null ? void 0 : parts.filter(part => 'functionCall' in part);
...
function getTextFromParts(parts) {
  const textParts =
    parts == null
      ? void 0
      : parts.filter(part => 'text' in part && part.thought !== true);
...
function extractSources({ groundingMetadata, generateId: generateId2 }) {
  var _a;
  return (_a =
    groundingMetadata == null ? void 0 : groundingMetadata.groundingChunks) ==
    null
    ? void 0
    : _a
